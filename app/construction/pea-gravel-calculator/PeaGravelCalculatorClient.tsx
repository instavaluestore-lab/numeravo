...
export default function PeaGravelCalculatorClient() {
  ...
  async function copyResults() {
    ...
    const resultText = `Numeravo Pea Gravel Estimate
Shape: ${shape}
${sizeText}
Depth: ${depth} in
Waste: ${wastePercent}%
    ...
    <section className="mt-10 grid gap-6 lg:grid-cols-[1fr_0.9fr]">
      <div className="rounded-2xl border border-[#1F2937] bg-[#121826] p-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <h2 className="mt-3 text-2xl font-semibold text-white">
              Estimate pea gravel cubic yards, tons, and cost
            </h2>

            <p className="mt-3 text-sm leading-7 text-[#A0AEC0]">
              Calculate pea gravel for patios, walkways, playground areas,
              landscaping beds, drainage areas, and decorative ground cover.
            </p>
          </div>
        ...
        <div className="mt-6 rounded-xl border border-[#1F2937] bg-[#0B0F19] p-4">
          <p className="text-sm font-semibold text-white">Common pea gravel depths</p>
      ...
      <div className="rounded-2xl border border-[#1F2937] bg-[#121826] p-6">
        ...
        <div className="mt-6 rounded-2xl border border-[#F97316] bg-[#0B0F19] p-5">
          <p className="text-sm text-[#A0AEC0]">Pea gravel needed</p>
        ...
        <div className="mt-6 rounded-xl border border-[#1F2937] bg-[#0B0F19] p-4">
          <p className="text-sm leading-6 text-[#A0AEC0]">
            Pea gravel is commonly used for decorative landscaping, patios,
            walkways, playground areas, drainage, and ground cover. Confirm
            density and delivery minimums with your local supplier.
          </p>
        </div>
      </div>
    </section>
